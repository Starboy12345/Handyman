...
public class HandyManTypesAdapter extends FirebaseRecyclerAdapter<HandyMan, HandyManTypesAdapter.MechanicViewHolder> {
     ...
     * @param options
     */
    public HandyManTypesAdapter(@NonNull FirebaseRecyclerOptions<HandyMan> options) {
        super(options);
    }

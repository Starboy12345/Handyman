...
public class HandymanLogin extends AppCompatActivity {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task)
                            {
                                if (task.isSuccessful())
                                {
                                    if (mAuth.getCurrentUser().isEmailVerified()){
                                        startActivity(new Intent(HandymanLogin.this, Main2Activity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK));
                                        finish();
                                        loadingbar.dismiss();
                                    }else{
        ...
        private void SendUsertoRegisterActivity()
        {
            ...
            Intent registeruser = new Intent(HandymanLogin.this, CustomerRegister.class);
